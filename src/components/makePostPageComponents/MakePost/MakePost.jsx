...
class MakePost extends Component {
    ...
    render() { 
        const { inputTitle, inputPrice,inputtime, inputLocation, inputDescription } = this.state
        return ( 
            ...
            <form onSubmit={this.submitHandler}>
                ...
                <div className="form-row">
                    ...
                    <div className="form-group col-md-4">
                        <label htmlFor="inputtime">Night Time</label>
                        <select id="inputtime" className="form-control" value={inputtime} onChange = { this.changeHandler } >
                                <option defaultValue>Choose...</option>
