        ...
        return (
            <>
                <div id="chatForm">
                    ...
                    <a href='/chating' > <input type="button" className="chatButton" value="Chat Now !" /> </a>
                </div>
                ...
                <div id="postForm">
                    ...
                    <form>
                        ...
                        <a href={`mailto: ${creatorEmail}?subject=The Roommate Hunt Notification [Posting]&body= Hi ${creatorName},%0D%0A%0D%0A ${message}%0D%0A%0D%0A Best Regards,%0D%0A ${name}%0D%0A${phone}`}><input type="button" value="Contact" /></a>
                    </form>
                </div>
            </>
        )
