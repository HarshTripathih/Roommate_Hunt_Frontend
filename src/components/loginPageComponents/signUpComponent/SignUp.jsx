...
class SignUp extends Component {
    ...
    render() { 
        const { firstname, lastname, email,aboutMe,phone, password, username } = this.state
        return ( 
            ...
            <form onSubmit={ this.submitHandler }>
                ...
                <div className="form-group">
                    <label>Phone</label>
                    <input type="phone" className="form-control" placeholder="Enter Phone Number" id='phone' value = {phone} onChange={this.changeHandler}/>
                </div>

                <div className="form-group">
                    <label>About Me</label>
                    <textarea rows="4" cols="50" className="form-control" placeholder="About You ?" id='aboutMe' value = {aboutMe} onChange={this.changeHandler}/>
                </div>
